<div class="document-header print-header" style="width:100%">
    <table width="100%">
        <tr>
            <td style="width:270px; text-align:center; vertical-align:middle; border:none; margin-bottom:20px;">
    ...
    <hr style="border-top:1px solid #000; margin-bottom:50px;">
